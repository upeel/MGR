...
<%@page import="com.mgr.manage.driver.and.technician.dao.ManageDriverOrTechnicianHeaderDAO"%>
...
<%
    ...
    if (action.equals("add")) {
        ...
        ManageDriverOrTechnicianHeaderDAO mdothdao = new ManageDriverOrTechnicianHeaderDAO();
...
//            msg = "No. of Users for this Authority Group has Reached the Limit!";
            ...
            String desName = designationController.getDesignationNameById(Integer.parseInt(uDesId));
            ...
            if(desName.equalsIgnoreCase("Technician")) {
                int techId = mdothdao.getTechIdByName(firstName);
                if(techId != 0) {
                    mdothdao.updateUserIdDTManagement(newlyaddeduserId, techId);
                }
            }
