<%-- 
    Document   : ServiceReportMessage
    Created on : 21 Nov, 2019, 4:56:54 PM
    Author     : Wildan
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="./include/js/ServiceReportMessage.js"></script>
        <title>Service Report Message</title>
    ...
    <body class="mgrBodyBGColor defaultPosition txtStyleSanRegularMgr" style="line-height: 100%;">
        ...
        <table class="box defaultPosition mgrBorderRadius tblWdth100 itemDetailSectionDiv tableMGRRounded bodyAndFormBorderMGR mgrSpace40" cellspacing="0" style="overflow: auto !important;">
            ...
            <tr>
                <td style="text-align: center;">
                    <input type="button" id="btnOk" onclick="OkOnClick()" name="btnOk" class="btnGreenVersionMGR" style="background: #197b30 !important;
