<%-- 
    Document   : ServiceReportResponsive
    Created on : 26 Aug, 2019, 9:47:54 AM
    Author     : Wildan
--%>
...
<html>
    <head>
        ...
        <script src="include/js/ServiceReportManual.js?v=${Version.VERSION}" type="text/javascript"></script>
    ...
    <body class="mgrBodyBGColor defaultPosition txtStyleSanRegularMgr">
        ...
        <div class="defaultBody">
            <form method="POST" id="frm" action="ServiceReportManual">
                    ...
                    <tbody id="tbodyServiceReport">
                        <tr>
                            ...
                            <td colspan="4" class="paddingTop paddingBottom mgrPaddingRight20 mgrPaddingLeft20">
                                <input type="hidden" id="orgunit" value="${param.orgunit}">
                                <input type="hidden" id="scid" name="scid" value="${scid}">
                                <input readonly maxlength="50" type="text" id="date" name="date" class="mgrFormDesign date maxWidth" value="<javatime:format value="${dateNow}" pattern="dd/MM/yyyy"/>"/>
                            </td>
                        </tr>   
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="paddingBottom mgrPaddingLeft20 mgrPaddingRight20">
                                <input readonly maxlength="50" type="text" id="jobNo" name="jobNo" class="mgrFormDesign jobNo maxWidth" value="${jobNo}"/>
                            </td>
                        </tr>  
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="paddingBottom mgrPaddingLeft20 mgrPaddingRight20">
                                <input readonly maxlength="50" type="text" id="company" name="company" class="mgrFormDesign company maxWidth" value="${compName}"/>
                            </td>
                        </tr> 
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="paddingBottom mgrPaddingLeft20 mgrPaddingRight20">
                                <input readonly maxlength="50" type="text" id="name" name="name" class="mgrFormDesign name maxWidth" value="${name}"/>
                            </td>
                        </tr> 
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="paddingBottom mgrPaddingLeft20 mgrPaddingRight20">
                                <input readonly maxlength="50" type="text" id="contact" name="contact" class="mgrFormDesign contact maxWidth" value="${contact}"/>
                            </td>
                        </tr> 
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="paddingBottom mgrPaddingLeft20 mgrPaddingRight20">
                                <input type="text" id="email" name="email" onchange="emailValidation(this);" class="mgrFormDesign maxWidth" value="${email}"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="paddingBottom mgrPaddingLeft20 mgrPaddingRight20">
                                <input readonly maxlength="50" type="text" id="model" name="model" class="mgrFormDesign model maxWidth" value="${machineModel}"/>
                            </td>
                        </tr> 
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="paddingBottom mgrPaddingLeft20 mgrPaddingRight20">
                                <input readonly maxlength="50" type="text" id="serialNo" name="serialNo" class="mgrFormDesign serialNo maxWidth" value="${serialNo}"/>
                            </td>
                        </tr> 
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="paddingBottom mgrPaddingLeft20 mgrPaddingRight20">
                                <input type="text" id="txtServiceDate" name="txtServiceDate" readonly class="mgrFormDesign serviceDate maxWidth" value="${service_date}"/>
                            </td>
                        </tr> 
                                ...
                                <c:forEach var="partUsed" items="${serviceReportHeader.listOfPartUsedDetails}" varStatus="loop">
                                    <tr id="trPart_${loop.count}" name="trPart_${loop.count}" class="trPart" >
                                        <td class="underline mgrPaddingLeft20 paddingTop paddingTopBottom">
                                            <img onclick="removeRow($(this));" id="remove_${loop.count}" class="remove" style="width: 20px; vertical-align: middle; cursor: pointer;" src="../../include/mgr/include/images/MGR-LOGO/Remove mgr.png"/>
                                        </td>
                                        ...
                                        <td class="underline mgrPaddingLeft20 mgrPaddingRight20 paddingTop paddingTopBottom">
                                            <input data-current="<fmt:formatNumber maxFractionDigits="1" value="${partUsed.quantity}" groupingUsed="false"/>" style="text-align: right; width: 50px;" type="number" id="txtQuantity_${loop.count}" name="txtQuantity_${loop.count}" class="mgrFormDesign txtQuantity" value="<fmt:formatNumber maxFractionDigits="1" value="${partUsed.quantity}" groupingUsed="false"/>">
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                    ...
                    <tbody id="tbodyEmail">
                        ...
                        <tr>
                            ...
                            <td colspan="4" class="paddingBottom mgrPaddingRight20 mgrPaddingLeft20">
                                <input type="text" maxlength="300" id="txtFollowUpRemark" name="txtFollowUpRemark" class="mgrFormDesign txtFollowUpRemark maxWidth admin"/>
                            </td>
                        </tr>
                                ...
                                <div class="sigPad admin" id="sigPad">
                                    ...
                                    <ul class="sigNav">
                                        <li class="clearButton" style="left:0; width: 50px;">
                                            <a href="#clear" class="txtStyleSanRegularMgr admin" id="clearSig">Clear</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
