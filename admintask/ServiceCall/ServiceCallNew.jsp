<%-- 
    Document   : ServiceCallNew
    Created on : 3 Oct, 2019, 1:27:44 PM
    Author     : Wildan
--%>
...
<html>
    <head>
        ...
        <script src="./include/js/ServiceCallNew.js" type="text/javascript"></script>
        <script>
            var listOfContractMdsMachineInfoJson = ${contractMdsMachineListJson};
        </script>    
    </head>
    <body class="mgrBodyBGColor defaultPosition">
     ...
     <div style="width: 100%; background-color: #ffffff;">
        ...
        <form id="frm" method="POST" action="ServiceCallNew">
            ...
            <div class="defaultPosition mgrBorderRadius tableMGRStyle tableMGRRounded bodyAndFormBorderMGR txtStyleSanRegularMgr" cellspacing="0">
                <div class="mgrDataTableThead">           
                    <div class="mgrTdPadTopBot20" style="text-align: center; width: 100%;">
                        Service Call
                        <input type="hidden" id="contractMdsMachineId" name="contractMdsMachineId" value="">
                        <input type="text" id="txtReferenceNo" name="txtReferenceNo" value="" hidden>
                    </div>
                </div>
                ...
                <div class="divFormMGR">
                    ...
                    <div class="row">
                        <div class="mgrTdPadTopBot20 col-25">
                            <label for="serialNo">Serial No <span class="mandatory">*</span></label>
                        </div>

                        <div class="col-75 mgrTdPadTopBot15">
                            <input type="text" id="txtSerial" class="mgrFormDesign" name="txtSerial" value="${serialNo}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-75 mgrTdPadTopBot15">
                            <input type="text" id="txtContact" class="mgrFormDesign" name="txtContact">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-75 mgrTdPadTopBot15">
                            <input type="text" id="txtEmail" onchange="emailValidation(this);" class="mgrFormDesign" name="txtEmail" value="">
                        </div>
                    </div>    
                    ...
                    <div class="row">
                        ...
                        <div class="col-75 mgrTdPadTopBot15">
                            <input type="text" id="txtSubmittedBy" class="mgrFormDesign" name="txtSubmittedBy" maxlength="50" value="${submittedBy}" readonly>
                        </div>
                    </div>
