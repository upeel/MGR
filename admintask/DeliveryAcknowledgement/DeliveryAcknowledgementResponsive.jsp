<%-- 
    Document   : DeliveryAcknowledgementResponsive
    Created on : 26 Aug, 2019, 9:46:41 AM
    Author     : Wildan
--%>
    ...
    <body class="mgrBodyBGColor defaultPosition txtStyleSanRegularMgr">
            ...
            <table class="formTableForLogoAndTable" style="width: 100%;">
                <tr>
                    ...
                    <td class="formTitleTableCell logoMGRTitleResp">
                        <h2 class="logoMGRTitleResp">Delivery Acknowledgement</h2>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="defaultBody">
            <form method="POST" id="frm" action="DeliveryAcknowledgement">
                ...
                <div class="defaultPosition mgrBorderRadius tableMGRStyle tableMGRRounded bodyAndFormBorderMGR txtStyleSanRegularMgr" cellspacing="0" style="overflow: auto !important;">                     
                    <div id="tbodyServiceReport">
                        <div class="row">
                            <div class="paddingTop paddingBottom mgrPaddingRight20 mgrPaddingLeft20 col-25">
                                Customer Name
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="paddingBottom mgrPaddingRight20 mgrPaddingLeft20 col-75">
                                <input readonly maxlength="50" type="text" id="deliveryDate" name="deliveryDate" class="mgrFormDesign underline inputNo deliveryDate maxWidth" value="${deliveryAcknowledgementHeader.delivery_date}"/>
                            </div>
                        </div>  
                        ...
                        <div class="row">
                            ...
                            <div class="paddingBottom mgrPaddingRight20 mgrPaddingLeft20 col-75">
                                <input readonly maxlength="50" type="text" id="txtDONo" name="txtDONo" class="mgrFormDesign underline inputNo invoiceNo maxWidth" value="${deliveryAcknowledgementHeader.do_no}"/>
                            </div>
                        </div> 
                        ...
                        <div class="row">
                            ...
                            <div class="paddingBottom mgrPaddingRight20 mgrPaddingLeft20 col-75">
                                <input readonly maxlength="50" type="text" id="orderNo" name="orderNo" class="mgrFormDesign underline inputNo orderNo maxWidth" value="${deliveryAcknowledgement.order_no}">
                            </div>
                        </div> 
                        ...
                        <div class="row">
                            ...
                            <div style="padding-bottom: 30px !important;" colspan="3" class="paddingBottom mgrPaddingRight20 mgrPaddingLeft20 col-75">
                                <input readonly maxlength="50" type="text" id="paymentMode" name="paymentMode" class="mgrFormDesign underline inputNo paymentMode maxWidth" value="${deliveryAcknowledgementHeader.payment_mode}">
                            </div>
                        </div>                         
                    </div>
                </div>
                                ...
                                <c:forEach var="item" items="${deliveryAcknowledgementHeader.listOfDeliveryOrderItemDetails}" varStatus="loop">
                                    <tr>
                                        ...
                                        <td class="paddingTop paddingBottom mgrPaddingLeft20" style="text-align: right;">
                                            <fmt:formatNumber value="${item.delivery_quantity}" maxFractionDigits="1"/>
                                        </td>
                                        ...
                                        <td class="paddingTop paddingBottom mgrPaddingLeft20 mgrPaddingRight20">
                                            ...
                                            <input ${deliveryAcknowledgementHeader.status == 'NEED_ACKNOWLEDGEMENT' ? '' : 'readonly'} 
                                                ...
                                                value="<fmt:formatNumber value="${item.receive_quantity}" maxFractionDigits="1"/>">    
                                            <input type="hidden" 
                                                   id="txtDeliveryQty_${loop.count}"
                                                   name="txtDeliveryQty_${loop.count}"
                                                   readonly
                                                   value="<fmt:formatNumber value="${item.delivery_quantity}" maxFractionDigits="1"/>">
                                        </td>
                                    </tr>
                                </c:forEach>       
