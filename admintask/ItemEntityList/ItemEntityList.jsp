            ...
            <form id="frm" method="POST" action="ItemEntityList">
                <table style="width: 100%">
                    <tr>
                        ...
                        <c:choose>
                            <c:when test="${param.customerSalesInformationDetailId != null && param.inv_type ne 'Meter Reading'}">
                                <td style="width: 25%;">
                            ...
                            <c:when test="${param.inv_type eq 'Meter Reading'}">
                                <td style="width: 25%;">
                                    <select id="ddlItemType" name="ddlItemType">
                                    <option value="8" ${param.ddlItemType eq '8' ? 'selected' : ''} selected>Contract</option>
                                    </select>
                                </td>
                            </c:when>
                            <c:otherwise>
                        ...
                        <c:if test="${param.inv_type ne 'Meter Reading'}">
                        <td style="width:1%"></td>
                        <td style="width: 6%;">
                    ...
                    <c:if test="${param.inv_type eq 'Meter Reading'}">
                        <tr>
                            <td class="txtStyleSanRegularMgr" style="width: 8%;">
                                Period (From)
                            </td>
                            <td style="width: 25%;">
                                <input type="text" class="mgrFormDesign periodFrom inputText" id="periodFrom" name="periodFrom" value="${param.from}" readonly>
                            </td>
                            <td style="width:3%"></td>
                            <td class="txtStyleSanRegularMgr mgrPaddingLeft20" style="width: 10%;">
                                Period (To)
                            ...
                            <td style="width: 25%;">
                                <input type="text" class="mgrFormDesign periodTo inputText" id="periodTo" name="periodTo" value="${param.to}" readonly>
                            </td>
				...
				<table style="width: 100%">
                    <td align="right">
                        <label>Search :  </label>
                        <input type="text" id="txtSearchItem" name="txtSearchItem" style="width: 20%; float: right;">
                    </td>
                </table>
                    ...
                    <tbody style="background-color: white;" id="tbodyContract">
                        <c:forEach items="${listOfItemEntityContract}" var="item" varStatus="loop">
                            <tr>           
                                ...
                                <td class="mgrTdPadTopBot20 mgrPaddingLeft20">
                                    <input id="ddlItemEntityUOM_${loop.count}" name="ddlItemEntityUOM_${loop.count}" class="ddlMgr" type="text" value="ie" readonly>
                        ...
                        <c:when test="${param.inv_type eq 'Meter Reading'}">
                            <thead class="mgrDataTableThead" id="theadContract">
                        <tr>
                            <th class="mgrTxtAlignLeft bdrBtmWhiteMgr mgrTdPadTopBot20 mgrPaddingLeft20" style="width: 25%;">Description</th>
                            <th class="mgrTxtAlignLeft bdrBtmWhiteMgr mgrTdPadTopBot20" style="width: 15%;">Start Meter</th>
                            <th class="mgrTxtAlignLeft bdrBtmWhiteMgr mgrTdPadTopBot20 mgrPaddingLeft20" style="width: 15%;">End Meter</th>
                            <th class="mgrTxtAlignLeft bdrBtmWhiteMgr mgrTdPadTopBot20 mgrPaddingLeft20" style="width: 15%;">BW / Color</th>
                            <th class="mgrTxtAlignLeft bdrBtmWhiteMgr mgrTdPadTopBot20 mgrPaddingLeft20" style="width: 15%;">Quantity</th>
                            <th class="mgrTxtAlignLeft bdrBtmWhiteMgr mgrTdPadTopBot20 mgrPaddingLeft20 mgrPaddingRight20" style="width: 15%;">Unit Price</th>
                            <th hidden></th>
                    ...
                    <tbody style="background-color: white;" id="tbodyContract">
                        <c:forEach items="${listOfItemEntityContract}" var="item" varStatus="loop">
                            <tr>           
                                ...
                                <td class="mgrTdPadTopBot20">
                                    <input type="text" id="txtStartMeter_${loop.count}" name="txtStartMeter_${loop.count}" class="mgrFormDesign startMeter" onchange="meterReadingValidation($(this));" onkeypress="return isNumberPlusComma(event, $(this));" value="${item.startMeter}" maxlength="50">
                                    <input type="hidden" class="startMeterVal" value="${item.startMeter}">
                                </td>
                                
                                <td class="mgrTdPadTopBot20 mgrPaddingLeft20">
                                    <input type="text" id="txtEndMeter_${loop.count}" name="txtEndMeter_${loop.count}" class="mgrFormDesign endMeter" onchange="bindMeterReadingValidation($(this));" onkeypress="return isNumberPlusComma(event, $(this));" value="${item.endMeter}" maxlength="50">
                                </td>

                                <td class="mgrTdPadTopBot20 mgrPaddingLeft20">
                                    <input id="ddlItemEntityUOM_${loop.count}" name="ddlItemEntityUOM_${loop.count}" class="mgrFormDesign" type="text" value="${item.uom_name}" readonly>
                                </td>

                                <td class="mgrTdPadTopBot20 mgrPaddingLeft20">
                                    <input type="text" style="text-align: right;" id="txtItemEntityQuantity_${loop.count}" name="txtItemEntityQuantity_${loop.count}" onkeypress="return isNumberPlusComma(event, $(this));" value="${item.quantity}" class="mgrFormDesign txtQuantity">
                                </td>
                                
                                <td class="mgrTdPadTopBot20 mgrPaddingLeft20 mgrPaddingRight20">
                                    <input type="text" style="text-align: right;" id="txtItemEntityOriginalPrice_${loop.count}" name="txtPrice_${loop.count}" value="<fmt:formatNumber value="${item.unit_price}" type="currency" maxFractionDigits="4" minFractionDigits="4"/>" onkeypress="return isNumberPlusComma(event, $(this));" onchange="changeUnitPrice($(this));" class="mgrFormDesign txtUnitPrice">
                                </td>
                                <td hidden>
                                    <input type="text" class="txtTotalPrice" id="txtItemEntityUnitPrice_${loop.count}" name="txtItemEntityUnitPrice_${loop.count}" value="${item.total_unit_price}" readonly hidden>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                ...
                <table id="dtItemEntityContractHidden" hidden>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="UOMContract_${loop.count}" class="uomCHidden" name="itemEntityUOMContract_${loop.count}" value="${item.uom_name}"></td>
                        <td><input type="text" id="startMeter_${loop.count}" class="startMeter" name="startMeter_${loop.count}" value="${item.startMeter}"</td>
                        <td><input type="text" id="endMeter_${loop.count}" class="endMeter" name="endMeter_${loop.count}" value="${item.endMeter}"</td>
                    </tr>
                    </c:forEach>
                    </tbody>
                </table>
