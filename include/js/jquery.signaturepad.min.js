        ...
        function r(a,e){
            ...
            i.each(function(){
                if(this.removeEventListener){
                    ...
                    if(this.ontouchstart)this.ontouchstart=null
                    });
            ...
            u=true;
            c("input").blur();
            if(typeof a.changedTouches!=="undefined")s=true;
            if(s){
                i.each(function(){
...
var q=this,b=c.extend({},c.fn.signaturePad.defaults,m),d=c(n),i=c(b.canvas,d),k=i.get(0),h=null,j={
    x:null,
    y:null
},l=[],p=false,s=false,u=false;
c.extend(q,{
    init:function(){
        G()
        },
...
c.fn.signaturePad.defaults={
    ...
    penWidth:2,
    penCap:"round",
    //lineColour:"#ccc",lineWidth:2,lineMargin:5,lineTop:35,
    name:".name",
    typed:".typed",
    clear:".clearButton",
    typeIt:".typeIt a",
